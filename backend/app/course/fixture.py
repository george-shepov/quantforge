...
from app.research.events import EventKind, MarketEvent, event_sort_key
...
def fixture_json() -> str:
    return json.dumps(course_fixture_payload(), indent=2, sort_keys=True)


def course_fixture_payload() -> dict[str, Any]:
    return {
